 ...
 implements ChatApp.ChatOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("game", new java.lang.Integer (6));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 4:  // ChatApp/Chat/post
       {
         ...
         this.post (objref, msg);
         out = $rh.createReply();
         break;
       }

       case 5:  // ChatApp/Chat/quit
       {
         ChatApp.ChatCallback objref = ChatApp.ChatCallbackHelper.read (in);
         this.quit (objref);
         out = $rh.createReply();
       ...
       case 6:  // ChatApp/Chat/game
       {
         ChatApp.ChatCallback objref = ChatApp.ChatCallbackHelper.read (in);
         String data = in.read_string ();
         this.game (objref, data);
         out = $rh.createReply();
         break;
       }
